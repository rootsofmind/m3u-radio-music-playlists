...
it's true but i only update this repo once every week as it's enough for me, you can use the link from the website instead if you are only interested in a few of those stations
```
